...
urlpatterns = [
    ...
    path("api/admin/users/<int:uid>/delete", views.api_admin_user_delete,
         name="api_admin_user_delete"),
    path("api/admin/users/<int:uid>/characters", views.api_admin_user_characters,
         name="api_admin_user_characters"),
    path("api/admin/characters/<int:pk>/delete", views.api_admin_character_delete,
         name="api_admin_character_delete"),
